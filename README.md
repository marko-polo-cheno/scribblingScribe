...
| ------ | ---- | ------- | ----- | --- | ------- | ---- |
| 032124 | Romans | 10 | 14 | 14 | Israel Rejects the Gospel | [Link](TBD) |<!--BIBLE_DATA_END-->

## Latest Prayer Data
<!--PRAYER_DATA_START-->
| MMDDYY | Time | Thanksgiving | Request | OOF |
| ------ | ---- | ------------ | ------- | --- |
| 032124 | night | study with church friends | guidance in work and holy work | missed thurs night b study |<!--PRAYER_DATA_END-->
