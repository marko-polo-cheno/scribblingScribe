...
| ------ | ---- | ------- | ----- | --- | ------- | ---- |
| 032324 | Romans | 11 | 1 | 10 | Israel’s Rejection Not Total | [Link](TBD) |<!--BIBLE_DATA_END-->

## Latest Prayer Data
<!--PRAYER_DATA_START-->
| MMDDYY | Time | Thanksgiving | Request | OOF |
| ------ | ---- | ------------ | ------- | --- |
| 032324 | night | sabbath went great and boba | guidance in choir | very sleepy in service |<!--PRAYER_DATA_END-->
